                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 mb-40">
                            <div className="strate-icon"><span /> Thiết kế UI/UX Chuyên nghiệp</div>
                            <h2 className="heading-2 mb-20">Dẫn đầu xu hướng thiết kế mới với phong cách thiết kế hiện đại chuyên nghiệp.</h2>
                                ...
                                <div className="col-lg-12">
                                    <div className="card-feature-2">
                                        ...
                                        <div className="card-info"><Link href="#">
                                            <h3 className="text-22-bold">Phong cách thiết kế đa dạng, hiện đại, gia tăng sự tương tác với khách hàng tiềm năng.
                                            </h3>
                                        </Link>
                                            <p className="text-md neutral-700">Luôn nắm bắt các xu thế mới, thay đổi liên tục để phát triển kịp xu hướng.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                    <div className="card-feature-2">
                                        ...
                                        <div className="card-info"><Link href="#">
                                            ...
                                            <p className="text-md neutral-700">Đội ngũ trẻ trung năng động luôn tìm tòi và sáng tạo, đưa ra những ý tưởng tốt nhất.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
