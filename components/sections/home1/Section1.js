                    ...
                    <div className="banner-inner-top">
                        <div className="container">
                            <div className="box-banner-left"><Link className="btn btn-brand-5-new" href="#"><span>New</span>AI
                                ...
                                <h1 className="display-2 mb-30 mt-25 neutral-0">Thiết kế Website - Mobile App Chuyên nghiệp với <br/>Nhất Tâm Solution</h1>
                                <p className="text-lg neutral-500 mb-55">Nhất Tâm Solution cung cấp các giải pháp và dịch vụ về phần mềm, thiết kế web, mobile app, giải pháp marketing, quản trị, SEO.                                </p>
