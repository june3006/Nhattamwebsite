            ...
            <Layout headerStyle={1} footerStyle={1} headerCls="header-style-2 header-style-4" >
                ...
                <section className="section-box box-content-blog-2 box-content-blog-post">
                    <div className="container">
                        <div className="text-center blog-head"><span className="btn btn-brand-4-sm">{item.title}</span>
                            <h2 className="heading-2 mb-20 mt-15">Perfect product images with Generative AI in Nivia platform</h2>
                            <p className="text-lg">dfsdfdsf</p>
                        </div>
                        <div className="row">
                            <div className="col-lg-1" />
                            <div className="col-lg-10">
                                <div className="box-content-detail-blog">
                                    <div className="box-image-header"> <img alt="Nivia" src="/assets/imgs/page/blog/img-detail.png" /></div>
