            ...
            <Layout headerStyle={1} footerStyle={1} headerCls="header-style-2 header-style-4" >
                <section className="section-box box-content-blog-2">
                    <div className="container">
                        <div className="text-center blog-head"><span className="icon-1 shape-1" /><span className="icon-2 shape-2" /><span className="icon-3 shape-3" /><span className="btn btn-brand-4-sm">OMGGGG</span>
                            <h2 className="heading-2 mb-20 mt-15">Các bài viết</h2>
                            <p className="text-lg">our blog and resources for valuable insights, expert opinions, and
